...
<html lang="en" class="light-style" dir="ltr" data-theme="theme-default" data-assets-path="assets/" data-template="vertical-menu-template-free">
  ...
  <head>
    ...
    <title>Nexvorta - Under Maintenance!</title>
    <meta name="description" content="" />
    <link rel="icon" type="image/x-icon" href="assets/img/icons/brands/deliserdanglogo.png"/>
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <p class="mb-4 mx-2">Maaf atas ketidaknyamanannya, tetapi kami sedang melakukan pemeliharaan saat ini.</p>
