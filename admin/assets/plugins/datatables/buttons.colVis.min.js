    ...
    columnVisibility: {
      ...
      init: function (b, a, d) {
        ...
        b.on("column-visibility.dt" + d.namespace, function (a, c) {
          c.bDestroying ||
            c.nTable != b.settings()[0].nTable ||
            g.active(b.column(d.columns).visible());
        }).on("column-reorder.dt" + d.namespace, function (c, g, e) {
          1 === b.columns(d.columns).count() &&
            ((d.columns = f.inArray(d.columns, e.mapping)),
            a.attr("data-cv-idx", d.columns),
            a
              .parent()
              ...
              .sort(function (a, b) {
                return (
                  1 * a.getAttribute("data-cv-idx") -
                  1 * b.getAttribute("data-cv-idx")
                );
              })
              .appendTo(a.parent()));
        });
      ...
      destroy: function (b, a, d) {
        b.off("column-visibility.dt" + d.namespace).off(
