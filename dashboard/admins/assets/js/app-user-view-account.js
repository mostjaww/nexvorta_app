document.addEventListener("DOMContentLoaded", function (e) {
  var t,
    s = document.querySelector(".datatable-project"),
    n = document.querySelector(".datatable-invoice");
  if (
    (s &&
      ((t = new DataTable(s, {
        ...
        columnDefs: [
          ...
          },
          {
            ...
            render: function (e, t, a, s) {
              return (
                '<span class="text-heading">' + a.project_leader + "</span>"
              );
            },
          },
          {
            ...
            render: function (e, t, a, s) {
              ...
              for (
                ...
                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Kim Karlos" class="avatar avatar-xs pull-up">
                  <img class="rounded-circle" src="${assetsPath}img/avatars/${n[e]}" alt="Avatar">
                </li>
              `),
                !(2 < ++o));
                e++
          ...
          },
          {
            ...
            orderable: !1,
            render: function (e, t, a, s) {
              return '<div class="d-inline-block"><a href="javascript:;" class="btn btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="icon-base bx bx-dots-vertical-rounded icon-md"></i></a><div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:;" class="dropdown-item">Details</a><a href="javascript:;" class="dropdown-item">Archive</a><div class="dropdown-divider"></div><a href="javascript:;" class="dropdown-item text-danger delete-record">Delete</a></div></div>';
            },
          },
        ],
        ...
        layout: {
          topStart: {
            rowClass: "row mx-md-2 justify-content-between",
            features: [{ pageLength: { menu: [7, 10, 25, 50, 75, 100] } }],
          },
          topEnd: {
            search: { placeholder: "Search Project", text: "_INPUT_" },
          },
          bottomStart: {
    ...
    s.classList.add(
      ...
      (s.innerHTML = "Invoice List");
    let a = new DataTable(n, {
      ...
      columnDefs: [
        ...
        },
        {
          targets: 1,
          render: (e, t, a, s) =>
            `<a href="app-invoice-preview.html"><span>#${a.invoice_id}</span></a>`,
        },
        {
          targets: 2,
          render: (e, t, a, s) => {
            ...
            return `
              <span class='d-inline-block' data-bs-toggle='tooltip' data-bs-html='true'
                ...
                ${
                  {
                    Sent: '<span class="badge badge-center d-flex align-items-center justify-content-center rounded-pill bg-label-success w-px-30 h-px-30"><i class="bx bx-check icon-xs"></i></span>',
                    Draft:
                      '<span class="badge badge-center d-flex align-items-center justify-content-center rounded-pill bg-label-primary w-px-30 h-px-30"><i class="bx bx-folder icon-xs"></i></span>',
                    "Past Due":
                      '<span class="badge badge-center d-flex align-items-center justify-content-center rounded-pill bg-label-danger w-px-30 h-px-30"><i class="bx bx-error icon-xs"></i></span>',
                    "Partial Payment":
                      '<span class="badge badge-center d-flex align-items-center justify-content-center rounded-pill bg-label-secondary w-px-30 h-px-30"><i class="bx bx-envelope icon-xs"></i></span>',
                    Paid: '<span class="badge badge-center d-flex align-items-center justify-content-center rounded-pill bg-label-warning w-px-30 h-px-30"><i class="bx bx-pie-chart-alt icon-xs"></i></span>',
                    Downloaded:
                      '<span class="badge badge-center d-flex align-items-center justify-content-center rounded-pill bg-label-info w-px-30 h-px-30"><i class="bx bx-down-arrow-alt icon-xs"></i></span>',
                  }[n]
                }
              </span>
            `;
        ...
        },
        {
          ...
          render: (e, t, a, s) => `
              <div class="d-flex align-items-center">
                <a href="javascript:;" class="btn btn-icon delete-record"><i class="bx bx-trash icon-md"></i></a>
      ...
      order: [[1, "desc"]],
      layout: {
        topStart: { rowClass: "row border-bottom mx-0 px-3", features: [s] },
        topEnd: {
          features: [
              ...
              buttons: [
                {
                  extend: "collection",
                  className:
                    "btn btn-label-secondary dropdown-toggle float-sm-end mb-3 mb-md-0 mt-md-0 mt-5",
      ...
      responsive: {
        details: {
          display: DataTable.Responsive.display.modal({
            header: function (e) {
              return "Details of " + e.data().invoice_id;
            },
          }),
          type: "column",
          renderer: function (e, t, a) {
    ...
    function o() {
      var e = document.querySelector(".datatable-invoice");
      let t = document.querySelector(".dtr-bs-modal");
      e && e.classList.contains("collapsed")
        ? t &&
          t.addEventListener("click", function (e) {
            e.target.parentElement.classList.contains("delete-record") &&
              (r(), (e = t.querySelector(".btn-close"))) &&
              e.click();
          })
        : (e = e?.querySelector("tbody")) &&
          e.addEventListener("click", function (e) {
            e.target.parentElement.classList.contains("delete-record") && r(e);
          });
    }
    o(),
      document.addEventListener("show.bs.modal", function (e) {
        e.target.classList.contains("dtr-bs-modal") && o();
      }),
  ...
  setTimeout(() => {
    [
      ...
      { selector: ".dt-layout-start", classToAdd: "px-4 mt-0" },
      { selector: ".dt-layout-end", classToAdd: "px-4 mt-0 gap-2" },
      {
