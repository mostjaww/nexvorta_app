              ...
              <div class="d-flex justify-content-left align-items-center">
                <div class="avatar-wrapper">
                  <div class="avatar avatar-sm me-4">
                    ${(c = a
                      ? `<img src="${assetsPath}img/avatars/${a}" alt="Avatar" class="rounded-circle">`
              ...
              return `<span class='text-truncate d-flex align-items-center text-heading'>${
                {
                  ...
                  Author:
                    '<i class="icon-base bx bx-edit text-warning me-2"></i>',
                  Maintainer:
                    '<i class="icon-base bx bx-user text-success me-2"></i>',
                  Editor:
                    '<i class="icon-base bx bx-pie-chart-alt text-info me-2"></i>',
                  Admin:
                    '<i class="icon-base bx bx-desktop text-danger me-2"></i>',
                }[a] || ""
              }${a}</span>`;
            },
          },
          ...
          this.api()
            ...
            .every(function () {
              ...
              (a.id = "UserRole"),
                ...
                (a.innerHTML = '<option value=""> Select Role </option>'),
                e.appendChild(a),
