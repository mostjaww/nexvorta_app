...
>
  <head>
    ...
    <link
      rel="stylesheet"
      href="../../assets/vendor/css/pages/app-invoice.css"
    />
    ...
    <div class="layout-content-navbar layout-wrapper">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="ms-2 app-brand-text demo menu-text fw-bold"
                >Sneat</span
              >
            </a>
            ...
            <a
              ...
              class="ms-auto text-large layout-menu-toggle menu-link"
            >
          ...
          <ul class="py-1 menu-inner">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="ms-auto rounded-pill text-bg-danger badge">5</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="app-kanban.html" class="menu-link">
                <i class="bx-grid menu-icon icon-base bx"></i>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="bx-dock-top menu-icon icon-base bx"></i>
            ...
            <!-- Components -->
            <li class="menu-header small">
              <span class="menu-header-text" data-i18n="Components"
                >Components</span
              >
            </li>
            <!-- Cards -->
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="ms-auto rounded-pill text-bg-primary badge">6</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="form-validation.html" class="menu-link">
                <i class="bx-list-check menu-icon icon-base bx"></i>
            ...
            <li class="menu-item">
              <a href="tables-basic.html" class="menu-link">
                <i class="bx-table menu-icon icon-base bx"></i>
        ...
        <div class="rounded-1 menu-mobile-toggler d-xl-none">
          <a
            href="javascript:void(0);"
            class="p-2 rounded-1 text-bg-secondary text-large layout-menu-toggle menu-link"
          >
        ...
        <div class="layout-page">
          ...
          >
            <div
              class="align-items-xl-center me-4 me-xl-0 layout-menu-toggle navbar-nav d-xl-none"
            >
              <a
                class="me-xl-6 px-0 nav-item nav-link"
                href="javascript:void(0)"
              >
            ...
            >
              ...
              <div class="align-items-center navbar-nav">
                <div class="mb-0 nav-item navbar-search-wrapper">
                  <a
                    class="px-0 nav-item nav-link search-toggler"
                    href="javascript:void(0);"
                  >
                    <span
              ...
              <ul class="flex-row align-items-center ms-md-auto navbar-nav">
                <!-- Language -->
                <li class="me-2 me-xl-0 nav-item dropdown-language dropdown">
                  <a
                ...
                <li class="me-2 me-xl-0 nav-item dropdown">
                  ...
                  >
                    <i
                      class="icon-base bx bx-sun icon-md theme-icon-active"
                    ></i>
                    <span class="ms-2 d-none" id="nav-theme-text"
                      >Toggle theme</span
                    >
                  </a>
                  <ul
                  ...
                  >
                    <li>
                      ...
                      >
                        <span
                          ><i
                            class="me-3 icon-base bx bx-sun icon-md"
                            data-icon="sun"
                          ></i
                          >Light</span
                        >
                    ...
                    <li>
                      ...
                      >
                        <span
                          ><i
                            class="me-3 icon-base bx bx-moon icon-md"
                            data-icon="moon"
                          ></i
                          >Dark</span
                        >
                    ...
                    <li>
                      ...
                      >
                        <span
                          ><i
                            class="me-3 icon-base bx bx-desktop icon-md"
                            data-icon="desktop"
                          ></i
                          >System</span
                        >
                ...
                <!-- Quick links  -->
                <li
                  class="me-2 me-xl-0 nav-item dropdown-shortcuts navbar-dropdown dropdown"
                >
                  <a
                    class="nav-link dropdown-toggle hide-arrow"
                    href="javascript:void(0);"
                  ...
                  <div class="p-0 dropdown-menu dropdown-menu-end">
                    <div class="border-bottom dropdown-menu-header">
                      <div
                        class="d-flex align-items-center py-3 dropdown-header"
                      >
                        <h6 class="me-auto mb-0">Shortcuts</h6>
                        <a
                          href="javascript:void(0)"
                          class="py-2 dropdown-shortcuts-add"
                          data-bs-toggle="tooltip"
                          data-bs-placement="top"
                          title="Add shortcuts"
                          ><i
                            class="text-heading icon-base bx bx-plus-circle"
                          ></i
                        ></a>
                      </div>
                    </div>
                    <div class="dropdown-shortcuts-list scrollable-container">
                      <div class="row-bordered overflow-visible row g-0">
                        <div class="dropdown-shortcuts-item col">
                          <span
                            class="mb-3 rounded-circle dropdown-shortcuts-icon"
                          >
                            <i
                              class="text-heading icon-base bx bx-calendar icon-26px"
                            ></i>
                          </span>
                        ...
                        <div class="dropdown-shortcuts-item col">
                          ...
                          >
                            <i
                              class="text-heading icon-base bx bx-food-menu icon-26px"
                            ></i>
                          </span>
                      ...
                      <div class="row-bordered overflow-visible row g-0">
                        <div class="dropdown-shortcuts-item col">
                          ...
                          >
                            <i
                              class="text-heading icon-base bx bx-user icon-26px"
                            ></i>
                          </span>
                        ...
                        <div class="dropdown-shortcuts-item col">
                          ...
                          >
                            <i
                              class="text-heading icon-base bx bx-check-shield icon-26px"
                            ></i>
                          </span>
                      ...
                      <div class="row-bordered overflow-visible row g-0">
                        <div class="dropdown-shortcuts-item col">
                          ...
                          >
                            <i
                              class="text-heading icon-base bx bx-pie-chart-alt-2 icon-26px"
                            ></i>
                          </span>
                        ...
                        <div class="dropdown-shortcuts-item col">
                          ...
                          >
                            <i
                              class="text-heading icon-base bx bx-cog icon-26px"
                            ></i>
                          </span>
                          <a
                            href="pages-account-settings-account.html"
                      ...
                      <div class="row-bordered overflow-visible row g-0">
                        <div class="dropdown-shortcuts-item col">
                          ...
                          >
                            <i
                              class="text-heading icon-base bx bx-help-circle icon-26px"
                            ></i>
                          </span>
                        ...
                        <div class="dropdown-shortcuts-item col">
                          ...
                          >
                            <i
                              class="text-heading icon-base bx bx-window-open icon-26px"
                            ></i>
                          </span>
                ...
                <!-- Notification -->
                <li
                  class="me-3 me-xl-2 nav-item dropdown-notifications navbar-dropdown dropdown"
                >
                  <a
                    class="nav-link dropdown-toggle hide-arrow"
                    href="javascript:void(0);"
                  ...
                  >
                    <span class="position-relative">
                      ...
                      <span
                        class="bg-danger border rounded-pill badge badge-dot badge-notifications"
                      ></span>
                    </span>
                  </a>
                      ...
                      >
                        ...
                        <div class="d-flex align-items-center mb-0 h6">
                          ...
                          <a
                            ...
                            ><i
                              class="text-heading icon-base bx bx-envelope-open"
                            ></i
                          ></a>
                        </div>
                      </div>
                        ...
                        >
                          <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                              ...
                              <small class="d-block mb-1 text-body"
                        ...
                        >
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <span
                                  class="bg-label-danger rounded-circle avatar-initial"
                                  >CF</span
                                >
                              </div>
                            </div>
                        ...
                        >
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <span
                                  class="bg-label-success rounded-circle avatar-initial"
                        ...
                        >
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <span
                                  class="bg-label-warning rounded-circle avatar-initial"
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="pages-profile-user.html">
                        <i class="me-3 icon-base bx bx-user icon-md"></i
                    ...
                    <li>
                      <a
                        ...
                        href="pages-account-settings-account.html"
                      >
                        <i class="me-3 icon-base bx bx-cog icon-md"></i
                        ><span>Settings</span>
                      </a>
                    </li>
                    <li>
                      ...
                      >
                        <span class="d-flex align-items-center align-middle">
                          <i
                            class="flex-shrink-0 me-3 icon-base bx bx-credit-card icon-md"
                          ></i
                          ><span class="flex-grow-1 align-middle"
                            >Billing Plan</span
                          >
                          <span
                            class="flex-shrink-0 bg-danger rounded-pill badge"
                            >4</span
                          >
                        </span>
                      </a>
                    ...
                    <li>
                      <a class="dropdown-item" href="pages-pricing.html">
                        <i class="me-3 icon-base bx bx-dollar icon-md"></i
                        ><span>Pricing</span>
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="pages-faq.html">
                        <i class="me-3 icon-base bx bx-help-circle icon-md"></i
                        ><span>FAQ</span>
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a
                        ...
                        target="_blank"
                      >
                        <i class="me-3 icon-base bx bx-power-off icon-md"></i
                        ><span>Log Out</span>
                      </a>
                    </li>
                  </ul>
                      ...
                      >
                        <div class="mb-6 mb-md-0">
                          ...
                          >
                            ...
                            <span class="ms-50 app-brand-text demo fw-bold"
                              >Sneat</span
                            >
                          </div>
                          <p class="mb-2">
                        ...
                        <div class="ps-0 ps-md-2 pe-0 col-md-5 col-8">
                          <dl class="mb-0 row gx-4">
                            ...
                            >
                              <span class="mb-0 text-capitalize text-nowrap h5"
                                >Invoice</span
                              >
                            </dt>
                            <dd class="col-sm-7">
                      ...
                      <form class="source-item">
                        ...
                        <div class="row">
                          <div class="col-12">
                            ...
                            >
                              <i class="me-1_5 icon-base bx bx-plus icon-xs"></i
                              >Add Item
                            </button>
                          </div>
                        </div>
                      ...
                      <div class="row-gap-4 row">
                        <div class="mb-4 mb-md-0 col-md-6">
                          <div class="d-flex align-items-center mb-4">
                            <label
                              for="salesperson"
                              class="me-2 text-heading fw-medium"
                              >Salesperson:</label
                            >
                            <input
                              type="text"
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div>
                            <label
                              for="note"
                              class="mb-1 text-heading fw-medium"
                              >Note:</label
                            >
                            <textarea
                              class="form-control"
...
It was a pleasure working with you and your team. We hope you will keep us in mind for future freelance projects. Thank You!</textarea
                ...
                <div class="col-lg-3 col-12 invoice-actions">
                    ...
                    <div class="card-body">
                      ...
                      >
                        <span
                          ...
                          ><i
                            class="me-2 icon-base bx bx-paper-plane icon-xs"
                          ></i
                          >Send Invoice</span
                        >
                      </button>
                      <a
                        ...
                        class="d-grid mb-4 w-100 btn btn-label-secondary"
                        >Preview</a
                      >
                      <button
                        type="button"
                  ...
                  <div>
                    <label for="acceptPaymentsVia" class="form-label"
          ...
          We would appreciate payment of this invoice by 05/11/2021</textarea
            ...
            <footer class="bg-footer-theme content-footer footer">
              <div class="container-xxl">
                <div
                  class="d-flex flex-column flex-md-row align-items-center justify-content-between py-4 footer-container"
                >
                  ...
                  <div class="d-lg-inline-block d-none">
                    ...
                    <a
                      href="https://themeselection.com/support/"
                      target="_blank"
                      class="d-sm-inline-block footer-link d-none"
                      >Support</a
                    >
                  </div>
                </div>
