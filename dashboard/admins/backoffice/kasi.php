...
<body>
  <div class="layout-content-navbar layout-wrapper">
    <div class="layout-container">
      ...
      <?php
      include_once $_SERVER['DOCUMENT_ROOT'] . '/sneat/features/sidebar.php';
      ?>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="flex-grow-1 container-p-y container-xxl">
            <div class="card">
              <h5 class="card-header">Verifikasi Kepala Seksi</h5>
                ...
                <table class="table table-striped">
                  ...
                  <tbody class="table-border-bottom-0">
                    <tr>
                      ...
                      <td>PERMOHONAN A</td>
                      <td>TANGGAL A</td>
                      <td><span class="bg-label-primary me-1 badge">PENGECEKAN</span></td>
                      <td>
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item" href="javascript:void(0);">
                            <i class="me-1 bx bx-edit-alt"></i> Edit</a>
                          <a class="dropdown-item" href="javascript:void(0);">
                            <i class="me-1 bx bx-trash"></i> Delete</a>
                        </div>
                      </td>
                    </tr>
                  </tbody>
