document.addEventListener("DOMContentLoaded", function (e) {
    ...
    r =
      (t &&
        ...
        window.Helpers.isNavbarFixed()
          ? ((t = document.getElementById("layout-navbar").offsetHeight),
  ...
  r &&
    ...
    (l = new DataTable(r, {
      ...
      layout: {
        topStart: { rowClass: "row card-header pt-0 pb-0", features: [t] },
        topEnd: { search: { placeholder: "" } },
        bottomStart: {
          rowClass: "row mx-3 justify-content-between",
          features: ["info"],
      ...
      initComplete: function (e, t) {
        r.querySelector("tbody tr:first-child").classList.add("border-top-0");
      },
    })),
    document.addEventListener("click", function (e) {
      e.target.classList.contains("delete-record") &&
