document.addEventListener("DOMContentLoaded", function (e) {
  ...
  o.length &&
    (r = o)
      ...
      .select2({ placeholder: "United States ", dropdownParent: r.parent() }),
    t &&
      new DataTable(t, {
        ...
        columnDefs: [
          ...
          },
          {
            targets: 3,
            render: function (e, t, o, r) {
              return "<span class='text-heading'>#" + o.customer_id + "</span>";
            },
          },
          {
            targets: 4,
            render: function (e, t, o, r) {
              ...
              <div class="d-flex justify-content-start align-items-center customer-country">
                <div>${
                  o
                    ? `<i class="icon-base fis fi fi-${o} rounded-circle me-2 icon-lg"></i>`
                          ...
                          format: {
                            body: function (e, t, o) {
                                ...
                                return e;
                              {
                                ...
                                let t = "";
                                var r = e.querySelectorAll(".customer-name");
                                return (
                                  0 < r.length
                                    ? r.forEach((e) => {
                                        e =
                                          e.querySelector(".fw-medium")
                                            ?.textContent ||
                                          e.querySelector(".d-block")
                                            ?.textContent ||
                                          e.textContent;
                                        t += e.trim() + " ";
                                      })
                                    : (t =
                                        e.body.textContent || e.body.innerText),
                                  t.trim()
                                );
                              }
                            },
                        ...
                        exportOptions: {
                          ...
                          format: {
                            body: function (e, t, o) {
                              ...
                              let r = "";
                              var n = e.querySelectorAll(".customer-name");
                              return (
                                0 < n.length
                                  ? n.forEach((e) => {
                                      e =
          ...
          details: {
            ...
            renderer: function (e, t, o) {
              ...
              return (
                ...
                ((s = document.createElement("tbody")).innerHTML = o),
                n.appendChild(s),
                r)
              );
            },
    ...
    setTimeout(() => {
      [
        ...
        { selector: ".dt-layout-end", classToAdd: "gap-2 mt-0 mb-md-0 mb-4" },
