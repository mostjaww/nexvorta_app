document.addEventListener("DOMContentLoaded", function (e) {
  let s = document.querySelector(".start_date"),
    l = document.querySelector(".end_date"),
        ...
        o.flatpickr({
          ...
          onClose: function (e, t, a) {
            ...
            void 0 !== e[0] &&
              ...
              (s.value = n)),
              void 0 !== e[1] &&
                ((n = new Date(e[1]).toLocaleDateString("en-US", {
                  month: "2-digit",
                  day: "2-digit",
                  year: "numeric",
                })),
  ...
  var t = document.querySelector(".datatables-ajax"),
    t =
      (t &&
        new DataTable(t, {
          processing: !0,
          ajax: { url: assetsPath + "json/ajax.php", dataSrc: "data" },
          layout: {
            topStart: {
  ...
  if (t) {
    ...
    a.appendChild(n);
    let s = a.querySelectorAll("tr:nth-child(2) th"),
      l =
        (s.forEach((e, t) => {
          var a = e.textContent,
          ...
          (n.type = "text"),
            ...
            t === s.length - 1 && (e.style.borderRight = "none"),
            (e.innerHTML = ""),
            e.appendChild(n),
            n.addEventListener("keyup", function () {
              l.column(t).search() !== this.value &&
                l.column(t).search(this.value).draw();
            }),
        ...
        details: {
          ...
          renderer: function (e, t, a) {
            ...
            return (
              ...
              ((l = document.createElement("tbody")).innerHTML = a),
              s.appendChild(l),
              n)
            );
          },
          ...
          ? ((e = s.value),
            ...
            "" !== e &&
              ...
              ((l, o, r) => {
                void 0 !== $.fn &&
                  void 0 !== $.fn.dataTableExt &&
                  $.fn.dataTableExt.afnFiltering.push(function (e, t, a) {
                    var t = d(t[l]),
                      n = d(o),
                      s = d(r);
                    return (
  ...
  (c = t
    ...
    : c).on("click", "td.dt-control", function (e) {
