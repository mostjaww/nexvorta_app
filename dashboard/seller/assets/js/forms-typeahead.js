document.addEventListener("DOMContentLoaded", () => {
  var s,
    ...
    a =
      (e &&
        document.querySelectorAll(".typeahead").forEach((e) => {
          e.setAttribute("dir", "rtl");
        }),
      $(".typeahead").typeahead(
        { hint: !e, highlight: !0, minLength: 1 },
        {
          name: "states",
          source:
            ((s = a),
  ...
  $(".typeahead-prefetch").typeahead(
    ...
    $(".typeahead-default-suggestions").typeahead(
      { hint: !e, highlight: !0, minLength: 0 },
      {
        name: "states",
        source: function (e, a) {
          "" === e
            ? a(t.get("Alaska", "New York", "Washington"))
            : t.search(e, a);
        },
      }
    );
  var a = new Bloodhound({
    ...
    o = document.querySelector(".typeahead-custom-template");
  o &&
    $(o).typeahead(
      { highlight: !0, hint: !e },
      {
  ...
  (o = (e) =>
    ...
    (o = document.querySelector(".typeahead-multi-datasets"));
  o && $(o).typeahead({ hint: !e, highlight: !0, minLength: 0 }, ...a);
});
