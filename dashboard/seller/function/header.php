<?php
include_once $_SERVER['DOCUMENT_ROOT'] . '/nexvorta_apps/dashboard/seller/config.php';
?>
...
<head>
  ...
  <title>Nexvorta Seller Dashboard</title>
  ...
  <link rel="icon" type="image/x-icon" href="<?php echo $base_url; ?>assets/img/nexva.png" />
