    ...
    <div class="app-brand demo">
        <a href="<?= $base_url ?>" class="app-brand-link">
            <span class="app-brand-logo demo">
                <img src="assets/img/nexva.png" alt="Logo" style="width: 40px; height: auto;" />
            </span>
            <span class="ms-3 app-brand-text fw-bolder menu-text" style="font-size: large; text-transform: uppercase;">Dashboard</span>
        </a>
